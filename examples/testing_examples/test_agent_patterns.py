...
class TestAgentBasics:
    ...
    def test_agent_custom_test_model_output(self, test_dependencies):
        ...
        with test_agent.override(model=test_model):
            ...
            assert result.output.message == "Custom test response"
            assert result.output.confidence == 0.9
            assert result.output.actions == ["test_action"]
...
class TestAgentTools:
    ...
    async def test_database_tool_success(self, mock_dependencies):
        ...
        with test_agent.override(model=test_model):
            ...
            assert "mock_database_query" in result.output.message
    ...
    def test_api_tool_with_data(self, mock_dependencies):
        ...
        with test_agent.override(model=test_model):
            ...
            assert "mock_api_call" in result.output.message
...
class TestAgentWithFunctionModel:
    ...
    def test_function_model_custom_behavior(self, test_dependencies):
        ...
        with test_agent.override(model=function_model):
            ...
            assert result1.output.message == "Normal operation"
            assert result1.output.confidence == 0.9
            ...
            assert result2.output.message == "Error detected and handled"
            assert result2.output.confidence == 0.6
            assert "error_handling" in result2.output.actions
    ...
    def test_invalid_output_handling(self, test_dependencies):
        ...
        with test_agent.override(model=test_model):
            ...
            try:
                ...
                assert not hasattr(result.output, 'invalid_field')
            except Exception as e:
